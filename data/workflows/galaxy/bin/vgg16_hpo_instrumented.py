...
def create_optuna_study():
    ...
    try:
        ...
        STUDY = optuna.load_study(study_name='Galaxy_Pegasus', storage='mysql://decaf_hpo_db_admin:3Iiidd_2s25j3w33jjdd@nerscdb04.nersc.gov/decaf_hpo_db', pruner=optuna.pruners.NopPruner(), log_db="log_db")
